...
if (isset($_POST['acao']) && $_POST['acao'] == 'cadastro') {
    ...
    $pesquisa = "SELECT * FROM adm WHERE usuario_login ='$email'";
    ...
    if ($retorno > 0) {
        ...
        $insert = "INSERT INTO adm(usuario_nome, usuario_login, usuario_senha, usuario_departamento) VALUES
...
<body>
    <nav class="navbar navbar-expand-lg bg-primary">
        <div class="container-fluid">
            <a class="navbar-brand" href="#"><img src="./img/senai-logo.png" width="142"
